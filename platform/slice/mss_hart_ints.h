 ...
 * to the E51 CPU, on receiving this interrupt the E51 should read the
 * maintenance system register to find out the interrupt source. The maintenance
...
/*
 * E51-0 is Maintenance Interrupt CPU needs to read status register to determine
 * exact cause: These defines added here for clarity need to replay with status
 * register defines for determining interrupt cause
 */
#ifndef FOR_CLARITY
